        ...
        <div className="header-container">
          ...
          <nav className="nav-bar">
            <ul className="nav-list">
              ...
              <li className="list-item"><a to="#staff-section" className="link">Staff</a></li>
              <li className="list-item"><a to="#reviews-section" className="link">Reviews</a></li>
              <li className="list-item"><a to="#location-section" className="link">Where To Find Us</a></li>
            </ul>
          </nav>
